...
Last source update: Sep 13, 2026, 12:43 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Apply in progress | Sep 13, 2026, 12:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34757062046) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 13, 2026, 12:36 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34757514510) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 13, 2026, 05:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34740998445) |
...
Last source update: Sep 13, 2026, 11:51 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1016 | 100% |
| Run attempts archived | 3109 | audit |
| Latest successful clusters | 854 | 84.1% |
| Latest failed clusters | 160 | 15.7% |
...
- Latest records: 1016 clusters: 324 maintainer action, 236 automation snapshot, 416 intervention needed, 40 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-146956](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146956.md) is automation_failed: Codex fix worker timed out after 1800000ms.
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#146921](https://github.com/openclaw/openclaw/pull/146921) is action_planned: A narrow existing-behavior repair is supported. Reproduce before editing, preserve selection and visibility semantics, and reuse the desi....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 324 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 236 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_failed | Codex fix worker timed out after 1800000ms | Sep 13, 2026, 11:51 UTC | [issue-openclaw-openclaw-146956](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146956.md) | [34753848833](https://github.com/openclaw/clawsweeper/actions/runs/34753848833) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-146956 | execute_fix blocked | Codex fix worker timed out after 1800000ms | [issue-openclaw-openclaw-146956](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146956.md) | [34753848833](https://github.com/openclaw/clawsweeper/actions/runs/34753848833) |
...
| --- | --- | --- | --- | --- | --- |
| [issue-openclaw-openclaw-146956](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146956.md) | blocked |  |  | Codex fix worker timed out after 1800000ms | [34753848833](https://github.com/openclaw/clawsweeper/actions/runs/34753848833) |
