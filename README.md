...
Last source update: Sep 14, 2026, 01:20 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 14, 2026, 01:20 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34795387336) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 14, 2026, 01:09 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34794903082) |
| [openclaw/clawsweeper](https://github.com/openclaw/clawsweeper) | Planning review | Sep 13, 2026, 21:43 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34784648961) |
...
Last source update: Sep 14, 2026, 01:12 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1026 | 100% |
| Run attempts archived | 3126 | audit |
| Latest successful clusters | 860 | 83.8% |
| Latest failed clusters | 164 | 16.0% |
| Latest cancelled clusters | 2 | 0.2% |
| Needs-human clusters | 123 | 12.0% |
| Fix actions failed | 34 | 4.6% |
| Fix actions blocked | 156 | 21.2% |
...
- Latest records: 1026 clusters: 325 maintainer action, 240 automation snapshot, 420 intervention needed, 41 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [issue-openclaw-openclaw-147587](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-147587.md) is automation_failed: Codex fix worker timed out after 1800000ms.
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#147387](https://github.com/openclaw/openclaw/pull/147387) is action_planned: An ordinary completion-visibility bug has a bounded repair path. Establish a failing regression on refreshed main before implementation;....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 325 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 240 | repair, check, or planned action recorded; verify live status |
| Intervention Needed | 420 | automation failure or blocker recorded |
| No Pending Action | 41 | latest record proposes no repair or apply action |
| Completed | 0 | latest record contains an executed merge or close |

| Lane state | Count |
| --- | ---: |
| maintainer_input | 178 |
| merge_ready | 45 |
...
| automation_active | 0 |
| action_planned | 196 |
| automation_failed | 179 |
| automation_blocked | 241 |
| reviewed_no_action | 41 |
| completed | 0 |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#146956](https://github.com/openclaw/openclaw/pull/146956) | action_planned | Restore the established Gateway-owned shutdown contract through the launcher layers, subject to a failing real-process regression on the executor's... | Sep 13, 2026, 12:47 UTC | [issue-openclaw-openclaw-146956](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146956.md) | [34757687635](https://github.com/openclaw/clawsweeper/actions/runs/34757687635) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#146921](https://github.com/openclaw/openclaw/pull/146921) | action_planned | A narrow existing-behavior repair is supported. Reproduce before editing, preserve selection and visibility semantics, and reuse the designated bra... | Sep 13, 2026, 11:31 UTC | [issue-openclaw-openclaw-146921](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146921.md) | [34754427364](https://github.com/openclaw/clawsweeper/actions/runs/34754427364) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#146800](https://github.com/openclaw/openclaw/pull/146800) | action_planned | The job defines a bounded bug fix that preserves both reconnect grace and historical hung-run recovery. No additional product decision is needed fo... | Sep 13, 2026, 07:35 UTC | [issue-openclaw-openclaw-146800](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146800.md) | [34745369591](https://github.com/openclaw/clawsweeper/actions/runs/34745369591) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#143727](https://github.com/openclaw/openclaw/pull/143727) | action_planned | The remaining Gateway regression has distinct value. Repair the existing PR using the attached artifact, resolve the recorded review findings, and... | Sep 12, 2026, 21:05 UTC | [automerge-openclaw-openclaw-143727](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/automerge-openclaw-openclaw-143727.md) | [34718603346](https://github.com/openclaw/clawsweeper/actions/runs/34718603346) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#146331](https://github.com/openclaw/openclaw/issues/146331) | action_planned | Prepare a regression-first implementation on the designated branch. Opening a PR remains contingent on reproducing the defect and passing validation. | Sep 12, 2026, 20:39 UTC | [issue-openclaw-openclaw-146331](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146331.md) | [34717343843](https://github.com/openclaw/clawsweeper/actions/runs/34717343843) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#146268](https://github.com/openclaw/openclaw/pull/146268) | action_planned | A focused diagnostic repair is supported. Reproduce through actual Linux startup before editing; stop for retriage if the defect does not reproduce... | Sep 12, 2026, 19:01 UTC | [issue-openclaw-openclaw-146268](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146268.md) | [34712600158](https://github.com/openclaw/clawsweeper/actions/runs/34712600158) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#146221](https://github.com/openclaw/openclaw/pull/146221) | action_planned | The reported draft-card defect has a narrow existing-owner repair. Reproduce before editing, then finalize successful acknowledged delivery during... | Sep 12, 2026, 18:02 UTC | [issue-openclaw-openclaw-146221](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146221.md) | [34709581666](https://github.com/openclaw/clawsweeper/actions/runs/34709581666) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#146124](https://github.com/openclaw/openclaw/pull/146124) | action_planned | The supplied evidence supports a focused bug fix with an existing metadata contract. Keep this issue open; closure and merge are prohibited. | Sep 12, 2026, 16:59 UTC | [issue-openclaw-openclaw-146124](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146124.md) | [34706611749](https://github.com/openclaw/clawsweeper/actions/runs/34706611749) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#145995](https://github.com/openclaw/openclaw/pull/145995) | action_planned | The diagnostic defect has a narrow repair path. First prove exhaustion through the real synchronous worker on current main; stop if reproduction fa... | Sep 12, 2026, 15:34 UTC | [issue-openclaw-openclaw-145995](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-145995.md) | [34702313844](https://github.com/openclaw/clawsweeper/actions/runs/34702313844) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#145993](https://github.com/openclaw/openclaw/pull/145993) | action_planned | A bounded repair plan is supported, but implementation must first reproduce the defect on current main. | Sep 12, 2026, 14:58 UTC | [issue-openclaw-openclaw-145993](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-145993.md) | [34700608750](https://github.com/openclaw/clawsweeper/actions/runs/34700608750) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#145938](https://github.com/openclaw/openclaw/pull/145938) | action_planned | The Git backup reader needs its own framing repair. No product or security judgment is required; implementation must first satisfy the job's exact-... | Sep 12, 2026, 13:02 UTC | [issue-openclaw-openclaw-145938](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-145938.md) | [34695060129](https://github.com/openclaw/clawsweeper/actions/runs/34695060129) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#145827](https://github.com/openclaw/openclaw/pull/145827) | action_planned | A focused bug repair is supported. Missing runtime proof and removal-proposal state are execution prerequisites, not unresolved product judgments. | Sep 12, 2026, 09:35 UTC | [issue-openclaw-openclaw-145827](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-145827.md) | [34685968401](https://github.com/openclaw/clawsweeper/actions/runs/34685968401) |

#### Intervention Needed

| Repository | Item | Lane state | Recorded blocker | Updated | Cluster | Run |
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) |  | automation_failed | Codex fix worker timed out after 1800000ms | Sep 14, 2026, 01:12 UTC | [issue-openclaw-openclaw-147587](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-147587.md) | [34792675753](https://github.com/openclaw/clawsweeper/actions/runs/34792675753) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [cluster:issue-openclaw-openclaw-147546](cluster:issue-openclaw-openclaw-147546) | automation_failed | Blocked until the executor refreshes main, reproduces the regression, implements the fix, completes validation and review, and prepares the authori... | Sep 14, 2026, 00:12 UTC | [issue-openclaw-openclaw-147546](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-147546.md) | [34790293765](https://github.com/openclaw/clawsweeper/actions/runs/34790293765) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#147511](https://github.com/openclaw/openclaw/pull/147511) | automation_failed | The canonical issue describes bounded broken presentation behavior. Reproduce against verified current main before changing production code; no clo... | Sep 13, 2026, 23:52 UTC | [issue-openclaw-openclaw-147511](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-147511.md) | [34788972615](https://github.com/openclaw/clawsweeper/actions/runs/34788972615) |
...
| --- | --- | --- | --- | --- |
| issue-openclaw-openclaw-147587 | execute_fix blocked | Codex fix worker timed out after 1800000ms | [issue-openclaw-openclaw-147587](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-147587.md) | [34792675753](https://github.com/openclaw/clawsweeper/actions/runs/34792675753) |
...
| --- | --- | --- | --- | --- | --- |
| [issue-openclaw-openclaw-147587](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-147587.md) | blocked |  |  | Codex fix worker timed out after 1800000ms | [34792675753](https://github.com/openclaw/clawsweeper/actions/runs/34792675753) |
