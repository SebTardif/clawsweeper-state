...
Last source update: Sep 13, 2026, 11:13 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Review in progress | Sep 13, 2026, 11:13 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34753742162) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Apply idle | Sep 13, 2026, 10:57 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34753105672) |
...
Last source update: Sep 13, 2026, 10:54 UTC

State: Failed clusters need inspection

| Metric | Count | Rate |
| --- | ---: | ---: |
| Latest clusters reviewed | 1015 | 100% |
| Run attempts archived | 3107 | audit |
| Latest successful clusters | 853 | 84.0% |
| Latest failed clusters | 160 | 15.8% |
...
- Latest records: 1015 clusters: 324 maintainer action, 235 automation snapshot, 416 intervention needed, 40 no pending action, 0 completed.
...
- Intervention first: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#146921](https://github.com/openclaw/openclaw/pull/146921) is automation_failed: Implementation requires a writable executor with installed dependencies. Source verification supports the repair, but a failing regressio....
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#146800](https://github.com/openclaw/openclaw/pull/146800) is action_planned: The job defines a bounded bug fix that preserves both reconnect grace and historical hung-run recovery. No additional product decision is....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 324 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 235 | repair, check, or planned action recorded; verify live status |
...
| --- | --- | --- | --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | [#146921](https://github.com/openclaw/openclaw/pull/146921) | automation_failed | Implementation requires a writable executor with installed dependencies. Source verification supports the repair, but a failing regression through... | Sep 13, 2026, 10:54 UTC | [issue-openclaw-openclaw-146921](https://github.com/openclaw/clawsweeper-state/blob/state/results/openclaw/issue-openclaw-openclaw-146921.md) | [34751526510](https://github.com/openclaw/clawsweeper/actions/runs/34751526510) |
