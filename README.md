...
Last source update: Sep 13, 2026, 20:48 UTC
...
| --- | --- | --- | --- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | Planning review | Sep 13, 2026, 20:48 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34781862535) |
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Planning review | Sep 13, 2026, 20:44 UTC | [run](https://github.com/openclaw/clawsweeper/actions/runs/34781645993) |
...
Last source update: Sep 13, 2026, 20:42 UTC
...
| Run attempts archived | 3117 | audit |
| Latest successful clusters | 856 | 83.8% |
| Latest failed clusters | 163 | 16.0% |
...
- Latest records: 1021 clusters: 325 maintainer action, 238 automation snapshot, 418 intervention needed, 40 no pending action, 0 completed.
...
- Automation latest: [openclaw/openclaw](https://github.com/openclaw/openclaw) [#147264](https://github.com/openclaw/openclaw/pull/147264) is action_planned: A focused bug repair is supported. Prepare the artifact for execution, retaining reproduction and contributor-PR discovery as prerequisit....
- Completed latest: no completed action in the latest records.

| Bucket | Count | Operator read |
| --- | ---: | --- |
| Maintainer Action | 325 | explicit decision, access, or merge authority recorded |
| Automation Snapshot | 238 | repair, check, or planned action recorded; verify live status |
